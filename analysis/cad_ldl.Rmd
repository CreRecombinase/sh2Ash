...
LDL->CAD |$g_{2,0}$ | 0.51(0.448, 0.577)    | 15.50          | 0.024(0.019, 0.030)  | 8.68     
LDL->CAD |qval$<0.2$| 0.480(0.372,0.589)    | 8.69           | 0.025(0.020, 0.031)  | 9.22
LDL->CAD | gwas     | 0.504(0.434, 0.574)   | 14.19          | 0.024(0.019, 0.029)  | 8.69
---------|----------|-----------------------|------          |----------------------|-------
CAD->LDL |$g_{2,0}$ | 0.089(0.067, 0.111)   | 7.76           |                      |
CAD->LDL |qval$<0.2$ | 0.049(0.005, 0.093) | 2.18           |                      |
CAD->LDL |gwas      | 0.075(0.054, 0.097)   | 6.97           |                      |
CAD->LDL |$g_{2,0}$ | 0.003 (-0.022, 0.028) | 0.24           | 0.027(0.020, 0.034)  | 7.58 
CAD->LDL |qval$<0.2$| 0.004(-0.045, 0.054)  | 0.17           | 0.028(0.022, 0.034)  | 8.82
CAD->LDL |gwas      | 0.005(-0.020, 0.029)  | 0.35           | 0.026(0.019, 0.033)  | 7.52
---------|----------|-----------------------|------          |----------------------|-------
LDL->HT  |$g_{2,0}$ |-0.041(-0.059, -0.022) | -4.32          |                      |      
LDL->HT  |qval$<0.2$| -0.07(-0.113, -0.035) | -3.73          |                      |
LDL->HT  |gwas      | -0.044(-0.066, -0.022)| -3.85          |                      |
LDL->HT  |$g_{2,0}$ |-0.028(-0.047, -0.010) |-3.03           |-0.049(-0.056, -0.043)| -14.84  
LDL->HT  |qval$<0.2$|-0.057(-0.096, -0.018) | -2.89          |-0.049(-0.056, -0.043)| -14.66
LDL->HT  |gwas      |-0.028 (-0.050,-0.006) | -2.54          |-0.049(-0.056, -0.043)| -14.76
---------|----------|-----------------------|------          |----------------------|-------
HT->LDL  |$g_{2,0}$ |-0.092(-0.104, -0.080) | -15.15         |                      | 
HT->LDL  |qval$<0.2$| -0.079(-0.103, -0.055)| -6.49          |                      |
HT->LDL  | gwas     | -0.086(-0.098, -0.073)| -13.68         |                      |
HT->LDL  |$g_{2,0}$ |-0.057(-0.072, -0.042) |-7.43           |-0.032(-0.040, -0.024)| -7.57 
HT->LDL  |qval$<0.2$| 0.004 (-0.023, 0.031) | 0.28           |-0.087(-0.101, -0.073)| -11.79
HT->LDL  |gwas      | -0.045 (-0.061, -0.29)| -5.64          |-0.038(-0.047, -0.029)| -8.47
